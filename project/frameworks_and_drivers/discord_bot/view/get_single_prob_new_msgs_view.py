class SingleProbNewMessagesView:
    ...
    def __str__(self) -> str:
        ...
        self.__MSG: str = f" ⚡ Probability of gaining {f"{self.__from_qtt} to {self.__to_qtt}" if self.__from_qtt < self.__to_qtt else self.__from_qtt } new messages tomorrow: {self.__tprob:.3f}%"
        if self.__tprob < 10:
            self.__MSG += " (Unlikely)"
